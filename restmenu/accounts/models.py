...
class Order(models.Model):
    ...
    supper1 = models.PositiveIntegerField(null=True, default=0)
    supper2 = models.PositiveIntegerField(null=True, default=0)
    meal1 = models.PositiveIntegerField(null=True, default=0)
    meal2 = models.PositiveIntegerField(null=True, default=0)
    meal3 = models.PositiveIntegerField(null=True, default=0)
    meal4 = models.PositiveIntegerField(null=True, default=0)
